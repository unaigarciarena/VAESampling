...
import cocoex
from VAE_ParetoApprox import VAE_E_E, VAEESDescriptor, create_descriptor, train
...
def vae_solver(n_layers, max_layer_size, divergence_measures, init_functions, lat_functions, act_functions, X_dim, z_dim, objectives, f_measure):

    population =
    descriptor = create_descriptor(n_layers, max_layer_size, divergence_measures, init_functions, lat_functions, act_functions, X_dim, z_dim, objectives, f_measure)
    vae = VAE_E_E(descriptor, objectives)
    vae = train()
